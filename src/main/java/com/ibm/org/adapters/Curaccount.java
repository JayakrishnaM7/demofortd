...
@Component
public class Curaccount implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private CurrentaccRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Curaccount.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Curaccount.class.getName());
         }else{
