...
@Component
public class Cprodandservices implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private CustomerprodsandservicesRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Cprodandservices.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Cprodandservices.class.getName());
         }else{
