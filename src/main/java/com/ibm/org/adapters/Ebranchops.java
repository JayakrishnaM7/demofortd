...
@Component
public class Ebranchops implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private EbranchopsRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Ebranchops.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Ebranchops.class.getName());
         }else{
