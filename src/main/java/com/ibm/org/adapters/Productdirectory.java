...
@Component
public class Productdirectory implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private ProductdirectoryRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Productdirectory.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Productdirectory.class.getName());
         }else{
